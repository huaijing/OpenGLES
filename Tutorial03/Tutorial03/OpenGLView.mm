...
//    m_uMatrix = glGetUniformLocation(_programHandle, "uMat");
    int attrpos = glGetAttribLocation(_programHandle, "aPos");
    int attrtex = glGetAttribLocation(_programHandle, "aCoord");
...
//    glVertexAttribPointer(attrpos, 3, GL_FLOAT, GL_FALSE, BUFFER_STRIDE, vertices);
//    glVertexAttribPointer(attrtex, 2, GL_FLOAT, GL_FALSE, BUFFER_STRIDE, vertices);
    glVertexAttribPointer(attrpos, 3, GL_FLOAT, GL_FALSE, 0, vertices);
    glVertexAttribPointer(attrtex, 2, GL_FLOAT, GL_FALSE, 0, vertices);
